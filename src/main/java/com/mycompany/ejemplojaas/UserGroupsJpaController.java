...
import com.mycompany.ejemplojaas.exceptions.NonexistentEntityException;
import com.mycompany.ejemplojaas.exceptions.PreexistingEntityException;
import com.mycompany.ejemplojaas.exceptions.RollbackFailureException;
...
public class UserGroupsJpaController implements Serializable
{
    ...
    public void create(UserGroups userGroups) throws PreexistingEntityException, RollbackFailureException, Exception
    {
        ...
        } catch (Exception ex)
        {
            ...
            if (findUserGroups(userGroups.getEmail()) != null)
            {
    ...
    public UserGroups findUserGroups(String id)
    {
        EntityManager em = getEntityManager();
        try
        {
